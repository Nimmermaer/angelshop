 ...
 */
class TeaserrowControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	{
		$this->subject = $this->getMock('MB\\Angelshop\\Controller\\TeaserrowController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllTeaserrowsFromRepositoryAndAssignsThemToView()
	{
		...
		$teaserrowRepository = $this->getMock('MB\\Angelshop\\Domain\\Repository\\TeaserrowRepository', array('findAll'), array(), '', FALSE);
	...
	{
		$teaserrow = new \MB\Angelshop\Domain\Model\Teaserrow();
