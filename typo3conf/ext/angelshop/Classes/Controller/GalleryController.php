...
class GalleryController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
     ...
     * galleryRepository
     * 
     * @var \MB\Angelshop\Domain\Repository\GalleryRepository
     * @inject
     */
     ...
     * action show
     * 
     * @param \MB\Angelshop\Domain\Model\Gallery $gallery
     * @return void
     */
    public function showAction(\MB\Angelshop\Domain\Model\Gallery $gallery)
    {
