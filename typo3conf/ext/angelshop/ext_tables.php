...
$boot = function ( $extensionKey ) {
	...
	\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addStaticFile( $extensionKey, 'Configuration/TypoScript', 'angelshop' );
	...
	\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addLLrefForTCAdescr( 'tx_angelshop_domain_model_fontawesome', 'EXT:angelshop/Resources/Private/Language/locallang_csh_tx_angelshop_domain_model_fontawesome.xlf' );
